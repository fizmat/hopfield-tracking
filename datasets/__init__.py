...
def get_hits(dataset: str = 'simple', n_events=None, *args, **kwargs) -> pd.DataFrame:
    ...
    from datasets.trackml import get_sample, get_sample_by_volume, get_one_event, get_one_event_by_volume
    ...
    if n_events == 1:
        getter = {
            ...
            'trackml': get_one_event,
            'trackml_volume': get_one_event_by_volume
        }[dataset]
        ...
        getter = {
            ...
            'trackml': get_sample,
            'trackml_volume': get_sample_by_volume
        }[dataset]
